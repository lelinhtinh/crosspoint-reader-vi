...
class CrossPointSettings {
 ...
 public:
  ...
  // fontFamily is kept for code compatibility but not exposed in settings UI.
  // Fork only loads Bookerly fonts; NOTOSANS/OPENDYSLEXIC objects are excluded (see main.cpp).
